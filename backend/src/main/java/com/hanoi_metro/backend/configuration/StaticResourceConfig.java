...
public class StaticResourceConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
                // Khi client request đến /product_media/**, Spring sẽ serve file từ thư mục
                // product_media/ trong project.
                ...
                // Khi client request đến /voucher_media/**, Spring sẽ serve file từ thư mục
                // vouchers/ trong project.
                registry.addResourceHandler("/voucher_media/**")
                                .addResourceLocations("file:uploads/vouchers/");

                // Khi client request đến /promotion_media/**, Spring sẽ serve file từ thư mục
                // promotions/ trong project.
                registry.addResourceHandler("/promotion_media/**")
                                .addResourceLocations("file:uploads/promotions/");

                // Khi client request đến /vouchers/** và /promotions/**, Spring sẽ serve file
                // từ thư mục vouchers/ và promotions/ trong project.
                ...
                // Khi client request đến /news_media/**, Spring sẽ serve file từ thư mục news
                // trong project.
                registry.addResourceHandler("/news_media/**")
                                .addResourceLocations("file:uploads/news/");

                // Khi client request đến /banner_media/**, Spring sẽ serve file từ thư mục
                // banners trong project.
                registry.addResourceHandler("/banner_media/**")
                ...
                // bạn có thể bật lại block bên dưới nhưng cần đảm bảo file thực sự tồn tại
                // trong thư mục uploads.
                // Hiện tại block này bị tắt để tránh log lỗi NoResourceFoundException khi
                // client request tới
