...
import com.hanoi_metro.backend.constant.ApiConstants;
import com.hanoi_metro.backend.dto.response.*;
import com.hanoi_metro.backend.dto.response.*;
...
import com.hanoi_metro.backend.configuration.GhnProperties;
...
import com.hanoi_metro.backend.util.ApiUtil;
...
public class GhnService {
    ...
    public GhnOrderDetailResponse getOrderDetail(String orderCode) {
        ...
        return apiUtil.callGhnApi(
                ...
                HttpMethod.POST,
                payload,
                new ParameterizedTypeReference<GhnApiResponse<GhnOrderDetailResponse>>() {},
                ghnProperties.getToken(),
                ghnProperties.getShopId());
    }
}
